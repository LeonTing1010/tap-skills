export default {
  site: "jimeng",
  name: "text2video",
  description: "即梦 AI 文生视频 — 调用本地 dreamina CLI 生成视频",
  ...
  args: {
    ...
    ratio: { type: "string", default: "16:9", description: "宽高比：16:9, 9:16, 1:1" },
    resolution: { type: "string", default: "720P", description: "分辨率：720P, 1080P" },
